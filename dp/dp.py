...
def main():
    size   = 50 # drawn size of each cell
    timer  = 1000 # ms sleep

    iters    = 1000  # GA iterations per update
    poolsz   = 2 # GA pool size (apx, will vary)
    numlines = 0 # number of lines to draw (e.g. top 10 best individ)
    apxratio = 0.99
