...
from sa_snake_utils import colorize

class SimulatedSnakeView(QGraphicsView):
    ...
    def __init__(self, width, height, size=10):
        super(SimulatedSnakeView, self).__init__()
    ...
    def __setup__(self):
        self._pen = QPen(SimulatedSnakeView.BLACK)
        self._brush = QBrush(SimulatedSnakeView.BLACK)
    ...
    def drawOpt(self, path):
        ...
        p.setWidth(2)
        p.setColor(SimulatedSnakeView.WHITE)
    ...
    def drawTopTen(self, snakes):
        ...
        p = self._pen
        p.setWidth(1)
        p.setColor(SimulatedSnakeView.BLACK)
        for s in snakes:
    ...
    def drawDp(self, snake):
        ...
        b = QBrush() # transparent brush
        p.setWidth(2)
        p.setColor(SimulatedSnakeView.BLUE)
